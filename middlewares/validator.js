...
module.exports = {
  register: [
    ...
    body("email")
      ...
      .bail()
      .isEmail()
      .withMessage("debes colocar un email valido")
      .bail()
      .custom((value) => {
        return User.findOne({
          where: {
    ...
    body("password")
      ...
      .bail()
      .custom((value, { req }) => req.body.password == req.body.passwordR)
      .withMessage("Las passwords no coinciden"),
    body("passwordR").notEmpty().withMessage("Este campo es obligatorio"),
  ],
  login: [
    body("emaillogin")
      .notEmpty()
      ...
      .custom((value, { req }) => {
        return User.findOne({
          ...
          if (resultado) {
            if (
              !bcrypt.compareSync(req.body.passwordlogin, resultado.password)
            ) {
  ...
  createProduct: [
    ...
    body("price")
      .notEmpty()
      .withMessage("Cual es el total a pagar?")
      .isInt()
  ...
  change: [
    ...
    body("newPassword")
      ...
      .withMessage("La contraseña debe tener por lo menos 8 caracteres")
      .bail()
      .custom((value, { req }) => req.body.newPassword == req.body.newPasswordR)
      .withMessage("Las passwords no coinciden"),
    body("newPasswordR").notEmpty().withMessage("Este campo es obligatorio"),
  ],
};
